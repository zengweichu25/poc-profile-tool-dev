...
public class WorkflowTemplateType {
    ...
    @NotNull(message = "Workflow template type name is required.")
    @Size(min = 1, max = 100, message = "Workflow template type name is required and cannot exceed 100 characters.")
    private String name;
